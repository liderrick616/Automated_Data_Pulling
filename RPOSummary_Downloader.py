...
# Target directory for RPO Summary
DOWNLOAD_DIR = r"C:\Users\DLI\Beam Suntory Inc\Canadian S&OP Collaboration Hub - Documents\Daily Reports\Daily Inventory - All Boards\1. BC\BCLDB Inventory Analysis\CW RPO Summary"
os.makedirs(DOWNLOAD_DIR, exist_ok=True)

# Generate filename: CW RPO Summary - yyyy-mm-dd.csv
current_date = datetime.now()
final_filename = f"CW RPO Summary - {current_date.strftime('%Y-%m-%d')}.csv"

# Calculate the "As far back as" date (First day of current year)
current_year = current_date.year
formatted_from_date = f"01-jan-{current_year}"

# =========================================================
# Custom Variables for RPO Summary
# =========================================================

TOOL_ID = "81"
FILTER_PAGE_URL = f"https://www.containerworld.com/CWFS/WEB_CAS/CAS_REPORT_INV_RSR_FILTER?p_online_tool_id={TOOL_ID}"
REPORT_INTERNAL_NAME = "dl_inv_rpo_summary"
...
print(f"Constructing pipeline payload... Setting 'From Date' to {formatted_from_date}")

# Payload includes dynamic P_FROM_DATE injection for the "As far back as" requirement
dl_url_string = (
    ...
    f"p_online_tool_id={TOOL_ID}|P_FROM_DATE={formatted_from_date}"
)
