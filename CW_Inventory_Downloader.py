...
# Target directory for CW Inventory
DOWNLOAD_DIR = r"C:\Users\DLI\Beam Suntory Inc\Canadian S&OP Collaboration Hub - Documents\Daily Reports\Daily Inventory - All Boards\1. BC\BCLDB Inventory Analysis\CW Inventory"
os.makedirs(DOWNLOAD_DIR, exist_ok=True)

# Generate filename: CW Inventory - yyyy-mm-dd.csv
current_date = datetime.now()
final_filename = f"CW Inventory - {current_date.strftime('%Y-%m-%d')}.csv"

# =========================================================
# Custom Variables for Detailed Inventory Sales Summary
# =========================================================

TOOL_ID = "188"
FILTER_PAGE_URL = f"https://www.containerworld.com/CWFS/WEB_CAS/CAS_REPORT_INV_DISSR_FILTER?p_online_tool_id={TOOL_ID}"
REPORT_INTERNAL_NAME = "dl_inv_sales_summary_ex"
...
# Payload perfectly matches Javascript architecture with pipe delimiters and mimetype
dl_url_string = (
    f"https://www.containerworld.com/reports/rwservlet?{REPORT_INTERNAL_NAME}|"
    "desformat=delimiteddata|delimited_hdr=yes|delimiter=,|mimetype=text/csv|"
    f"p_resolution=1024|p_online_tool_id={TOOL_ID}"
)
